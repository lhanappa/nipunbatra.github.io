...
\newcommand{\deadline}{Midnight Feb 19}
\newcommand{\extdeadline}{Midnight Feb 21}
\newcommand{\total}{22}
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Stochastic Gradient desent where initial values of $\theta_0, \theta_1)$ is (0, 0) and step size (or learning rate) is $\alpha=0.1$. Show the calculations for initial 2 epochs (or 2*3 iterations). \textbf{[1 mark]} 
